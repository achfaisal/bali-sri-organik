  ...
  return (
    <BackgroundBlurSection>
      <section className="container mx-auto px-4 rounded-lg">
        <h1 className="text-center text-4xl font-extrabold pt-10 text-white">
          Milestone
        </h1>
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical py-10">
          {t.raw("Timeline").map((item, index) => (
            ...
            >
              ...
              >
                <div className="bg-white/70 shadow-lg p-6 rounded-lg transition-all transform hover:-translate-y-1">
                  <div className="mb-2">
